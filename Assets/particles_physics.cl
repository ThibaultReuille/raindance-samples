...
__kernel void sine_wave(__global Instance* instances, float time)
{
    unsigned int id = get_global_id(0);

    float3 pos = instances[id].Translation.xyz;
    ...
    instances[id].Translation.y = pos.y;
    instances[id].Translation.z = pos.z;
}
